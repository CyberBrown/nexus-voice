...
# Check v4 embedding stats
print("=== v4 embedding check ===")
tts = Qwen3TTSModel.from_pretrained("/workspace/output/samantha_v4/checkpoint-epoch-2", device_map="cuda:0", dtype=torch.bfloat16, attn_implementation="sdpa")
...
sf.write("/data/output/test_v4_short.wav", wavs[0], sr)
...
sf.write("/data/output/test_v4_long.wav", wavs2[0], sr2)
